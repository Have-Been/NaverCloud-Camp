...
public class _03_String02 {
	...
	public static void main(String[] args) {
		...
		String str3 = "abcha bcdeba";
		
		// 1. contains : 문자열을 포함하는 지 여부를 검사하는 메소드
		...
		// 포함되어 있으면 해당 문자의 인덱스를 찾아서 리턴, 포함되어 있지 않으면 -1 리턴
