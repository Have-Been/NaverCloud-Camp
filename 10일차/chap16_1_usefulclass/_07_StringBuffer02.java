...
public class _07_StringBuffer02 {
	...
	public static void main(String[] args) {
		...
		// 버퍼의 크기인 16보다 길이가 긴 문자열을 append하면 자동으로 문자열의 길이에 맞춰서
		// 버퍼의 크기가 증가한다.
		...
		// sb2에 있는 공백 삭제
		sb2.reverse();
		System.out.println(sb2); // 공백 삭제 전
		
		System.out.println(sb2.toString().trim()); // 공백 삭제 후
