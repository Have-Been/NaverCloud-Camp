...
public class _12_BoxingUnboxing {
	...
	public static void main(String[] args) {
		...
		// (Integer) 생략 가능. 하지만 알아볼 수 있게 명시
		Integer objNum1 = (Integer)num1;
		
		// 2. 자동 박싱 : 컴파일러가 알아서 기본 타입의 값을 래퍼클래스의 객체로 변환하는 기능
		// 객체 타입 + 기본 타입인데 자동 박싱이 일어나서 더하기가 가능
		Integer objNum2 = objNum1 + num1;
		
		// 3. 언박싱(Unboxing) : 래퍼클래스 객체에 저장되어 있는 값을 포장을 해체하여 기본타입의 값으로 변환하는 것
		int num2 = (int)objNum2;
		
		// 4. 자동 언박싱 : 컴파일러가 알아서 래퍼클래스의 객체에 저장되어 있는 값을 기본타입의 값으로 변환해주는 기능
