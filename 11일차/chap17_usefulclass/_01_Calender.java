...
public class _01_Calender {

	public static void main(String[] args) {
		// 1. Calender 객체 생성
		// Calender 클랫의 static 메소드인 getInstance()를 이용해서 객체를 생성한다.
		...
		// set 메소드는 Calendar 객체가 생성된 후에 사용 가능하다.
		Calendar oneDay = Calendar.getInstance();
		oneDay.set(2024, 4, 24, 9, 53, 30); // 2024년 4월 24일 9시 53분 30초를 갖는 Calendar 객체
		System.out.println("------------------------------");
	...
	public static String DateToString(Calendar calendar) {
		...
		return "오늘은 " + calendar.get(Calendar.YEAR) + "년 " + 
	...
	public static String TimeToString(Calendar calendar) {
		...
		return "지금은 " + calendar.get(Calendar.HOUR_OF_DAY) + "시 " + 
