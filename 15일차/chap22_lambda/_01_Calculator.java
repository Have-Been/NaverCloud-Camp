...
public class _01_Calculator {
	...
	public static void main(String[] args) {
		...
		// 2. 함수형 인터페이스를 익명 객체로 구현
		calc(num1, num2, new Calculator() {
			
			@Override
			public void calculatior(int a, int b) {
	...
	// 함수형 인터페이스의 구현체를 구현하는 방법은 익명 객체와 람다식이다.
	public static void calc(int a, int b, Calculator calculator) {
		// 왜 클래스에 void를 쓰는걸까 알아보기
		calculator.calculatior(a, b);
	}
