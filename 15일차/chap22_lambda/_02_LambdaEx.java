...
public class _02_LambdaEx {

	public static void main(String[] args) {
		// 1. 소문자로 변환하는 추상메소드(ConvertcaseString 인터페이스의 toConvertcase) 
		// 람다식으로 구현
		// 여기서 구현한 람다식의 내용이 toConvertcase의 동작으로 만들어진다. 
		printConvertrCase(s1 -> s1.toLowerCase());
		
		// 2. 대문자로 변환하는 추상메소드 람다식으로 구현
		printConvertrCase(string -> string.toUpperCase());

	}
	
	public static void printConvertrCase(ConvertcaseString convertcaseString) {
