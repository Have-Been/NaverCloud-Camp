...
public class PhoneInfo {
	// 이름이 key, 전화번호가 value
	// 고기천, 010-1111-1111
	List<Map<String, String>> phoneInfoList = new ArrayList<Map<String,String>>();
	...
	public  PhoneInfo() {
		...
		try {
			...
			Reader reader = new FileReader(
					"D:/lecture/Java/javaprograming/src/chap24_dataio/PhoneInfo.txt"
			);
...
//			BufferedReader bufferedReader = new BufferedReader(reader);
			...
			while(true) {
				// 3. readLine() : 파일의 한 줄을 문자열로 읽어오는 메소드, String 반환
				...
				Map<String, String> phoneInfoMap = new HashMap<String, String>();
				// split : 특정 문자열을 기준으로 자름
