...
public class Numbaseball {
	// 1. 컴퓨터가 0~9까지의 숫자 중 랜덤한 값 3개를 배열에 저장 (중복 불가능)
	...
	// ex. com {1, 2, 3} user {1, 3, 5} ==> 1스트라이크 1볼
	//     com {1, 2, 3} user {4. 5. 6} ==> 0스트라이크 0볼
	//     com {1, 2, 3} user {3, 1, 2} ==> 0스트라이크 3볼
	//     com {1, 2, 3} user {1, 2, 3} ==> 3스트라이크 아웃 게임종료 (다 맞출시 게임종료)
...
//			System.out.println("원하는 숫자를 3개 입력하세요. ");
//			
//			for(int i = 0; i < user.length; i++) {
//				user[i] += userNum;
//				
